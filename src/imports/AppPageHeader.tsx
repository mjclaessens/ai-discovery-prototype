...
import svgPaths from "./svg-gmzksqch85";
...
function SerpHeaderSearch({
  ...
  return (
    <form
      ...
      className="flex w-full min-w-0 flex-1 items-center justify-between gap-2 overflow-hidden rounded-[24px] border border-solid border-[#dae1ed] bg-white py-1 pl-4 pr-1"
      ...
      <div className="flex flex-row items-center size-full">
        ...
        >
          <Left className={serp ? "min-w-0 flex-1" : "shrink-0"}>
            {serp ? (
              <SerpHeaderSearch query={serp.query} onQueryChange={serp.onQueryChange} onSubmit={serp.onSearchSubmit} />
            ) : null}
          </Left>
          <Right>
            {serp ? (
